...
# library(here)
# #
# source(here("R/get_linked_objects.R"))
# source(here("R/get_people_by_faculty.R"))
# # Metadata functions
# source(here("R/add_metadata.R"))
# source(here("R/get_object_metadata.R"))
# source(here("R/get_object_info.R"))
# 
# source(here("R/pluck_content.R"))
# source(here("R/pluck_applicant.R"))
# 
# 
# # Load the key
